...
import jaemukyang.spring.mvc.dao.PdsDAO;
import jaemukyang.spring.mvc.util.FileUpDownUtil;
import jaemukyang.spring.mvc.vo.Pds;
...
public class PdsServiceImpl implements PdsService{
    ...
    public boolean newPds(Pds p, MultipartFile[] file) {
        ...
        // 배열에 저장한 정보들을 하나씩 추출해서 Pds 에 저장
    ...
    @Override
    public void modifyRecommd(String pno) {
        pdao.updateRecommd(pno);
    }
    ...
    public Pds removePds(String pno) {
        Pds p = pdao.selectOnePds(pno);     // 나중에 첨부파일을 삭제하기 위해
                                            // 삭제하기전 파일정보를 알아냄
