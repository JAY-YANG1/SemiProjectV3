...
<div id="main">
	...
	<div>
	    ...
	    <div class="row">
	        <div class="col-5 offset-1">
	            <button type="button" class="btn btn-warning text-white" id="modgbtn">
	    ...
	    <div class="row">
	        <form name="replyfrm" id="replyfrm"
	            ...
	            <div class="form-group row justify-content-center">
	                <label class="col-form-label col-2 pushdwn text-center"
	                       for="reply">작성자</label>
	                <textarea class="form-control col-7" name="reply" id="reply" rows="5">
	                </textarea>
	                &nbsp;&nbsp;
