...
<div id="main">
	...
	<div class="row">
	    <div class="col-5 offset-1">
	        <h3><i class="far fa-edit"> 수정하기</i></h3>
	    </div>
	    ...
	    <form name="modgalfrm" id="modgalfrm">
	        <div class="form-group row">
	            ...
	            <input type="text" name="title" id="title"
	                   class="form-control col-9 border-danger" value="${g.title}">
	        </div>
	        ...
	        <div class="form-group row">
	            ...
	            <input type="text" name="userid" id="userid"
	                   class="form-control col-9 border-danger" readonly value="${g.userid}">
	        </div>
	        ...
	        <div class="form-group row">
	            ...
	            <textarea name="contents" id="contents" rows="15"
	                      class="form-control col-9 border-danger">${g.contents}
	            </textarea>
	        </div>
