...
<div id="main">
    ...
    <nav>
     ...
     <div>
        <h2>회원정보 입력</h2>
        <small class="text-muted">회원정보는 개인정보 취급방침에 따라 안전하게 보호되며, 회원님의
            명백한 동의없이 공개 또는 제3자에게 제공되지 않습니다.</small>
    </div> <!--섹션 타이틀 -->
            ...
            <div class="row">
                <div class="col-11 offset-1">
                    ...
                    <div class="form-group row">
                        ...
                        <span id="uidmsg" class="col-form-label">&nbsp;8~16 자의 영문 소문자,
                            숫자와 특수기호(_)만 사용할 수 있습니다.</span>
                    </div><!-- 아이디 -->
                    ...
                    <div class="form-group row">
                        ...
                        <input type="password" name="passwd" id="passwd"
                               class="form-control border-danger col-3">
                        <span id="pwdmsg" class="col-form-label">&nbsp;8~16 자의 영문 대소문자,
                            숫자와 특수문자 사용할 수 있습니다.</span>
                    </div><!-- 비번 -->
                    ...
                    <div class="form-group row">
                        ...
                        <input type="password" name="repasswd" id="repasswd"
                               class="form-control border-danger col-3">
                        <span class="col-form-label">&nbsp;이전 항목에서 입력했던 비밀번호를
                            한번 더 입력하세요.</span>
                    </div><!-- 비번확인 -->
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <button type="button" class="btn btn-primary"
                            id="joinbtn"><i class="fas fa-check-circle"></i> 입력완료</button>
                    <button type="button" class="btn btn-danger"
                            id="cancelbtn"><i class="fas fa-times-circle"></i> 입력취소</button>
                </div>
            </div><!-- 버튼들 -->
                ...
                <div class="modal-body">
                    <form name="zipfrm" id="zipfrm">
                        <div class="form-inline row justify-content-center">
                            <label class="col-form-label text-primary text-right" for="dong">
